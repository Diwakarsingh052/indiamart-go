...
// CreateLargeBuffer allocates a large buffer and returns a pointer to it
func CreateLargeBuffer() *bytes.Buffer {
	//data := make([]byte, 1024*1024*2) // Allocating 2MB of data
