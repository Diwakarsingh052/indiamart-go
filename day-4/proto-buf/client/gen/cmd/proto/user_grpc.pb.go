...
func (c *userServiceClient) CreatePost(ctx context.Context, opts ...grpc.CallOption) (UserService_CreatePostClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], UserService_CreatePost_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) GetPosts(ctx context.Context, in *GetPostsRequest, opts ...grpc.CallOption) (UserService_GetPostsClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], UserService_GetPosts_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
